          ...
          <div className="grid lg:grid-cols-2 gap-6 w-full">
            ...
            <div className="rounded-xl border border-white/10 p-4 bg-white/5">
              ...
              <div className="h-[260px]">
                <ResponsiveContainer width="100%" height="100%" className="ml-[-60%]">
                  <BarChart data={consultasPorEstado} margin={{ top: 8, right: 8, left: 8, bottom: 8 }}>
            ...
            <div className="rounded-xl border border-white/10 p-4 bg-white/5 w-full">
              ...
              <div className="h-[260px]">
                <ResponsiveContainer width="100%" height="100%" className="ml-[-50%]">
                  <PieChart>
                    <Tooltip content={<GlassTooltip />} />
                    <Legend
                      wrapperStyle={{ color: "#fff" }}
