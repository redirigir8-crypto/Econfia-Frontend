...
export default function Resultados() {
  ...
  return (
    <div className="w-full h-[70vh] p-8 pt-0">
      {!consultaSeleccionada ? (
        <div className="w-[80%] mt-12">
          <h1 className="text-2xl font-bold mb-4 text-white">Resultados</h1>
          ...
          <div className="flex justify-between items-center mb-6 gap-4">
            <input
              ...
              className="w-1/2 px-4 py-2 rounded-xl bg-white/5 border border-white/20 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-400 shadow-inner"
            />
            ...
            <div className="flex gap-3">
              <select
                ...
                className="px-4 py-2 rounded-xl bg-white/5 border border-white/20 text-white focus:outline-none focus:ring-2 focus:ring-blue-400"
              >
